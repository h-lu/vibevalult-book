...
::: {.video-container}
<iframe src="//player.bilibili.com/player.html?bvid=BV1pEaHzaEQD&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" height="400"></iframe>
:::
...
```bash
rm -rf ~/.gradle/wrapper/dists/gradle-9.0.0* ~/.gradle/caches
./gradlew --version | cat
./gradlew build
```
